...
import { useMainInfo } from "../hooks/useDartApi";
...
const MainInfo: React.FC = () => {
  ...
  const { data, isLoading, error } = useMainInfo(
  ...
  return (
    <PageContainer>
      <PageTitle>정기보고서 주요정보</PageTitle>
      <PageDescription>
        기업의 주요 경영지표와 핵심 정보를 확인할 수 있습니다.
      </PageDescription>
